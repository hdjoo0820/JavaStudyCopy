...
public class EmpDept {
	...
	public EmpDept(ResultSet rs) throws SQLException {
		...
		dept_manager_id = rs.getString("dept_manager_id");
	...
	public String getDept_manager_id() {
		return dept_manager_id;
	}
	public void setDept_manager_id(String dept_manager_id) {
