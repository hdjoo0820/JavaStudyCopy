...
public class A03_VariableTypes {
	...
	public static void main(String[] args) {
		...
		// char 타입에는 0 ~ 65535의 문자 코드를 정수타입으로 보관할 수 있다
		// (ASCII 코드표 검색)
		
		// '' : 문자 타입 리터럴도 숫자로 인식되기 떄문에 정수 타입 변수에 저장할 수 있다
		
		// ch1 ~ ch5번의 값을 변경하며 lunch라고 출력되게 만들어보세요
		char ch1 = 108;		//char ch1 = 'l';
		char ch2 = 117;		//char ch2 = 'u';
		char ch3 = 110;		//char ch3 = 'n';
		char ch4 = 99;		//char ch4 = 'c';
		char ch5 = 104;		//char ch5 = 'h';
		...
		System.out.println("int타입에 들어갈 수 있는 가장 큰 값은\n " + max_int + "이고,\n"
				+ "가장 작은 값은\n " + min_int + "입니다.");
	
		System.out.println("long타입에 들어갈 수 있는 가장 큰 값은\n " + max_long + "이고,\n"
				+ "가장 작은 값은\n " + min_long + "입니다.");
