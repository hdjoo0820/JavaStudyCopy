...
// Ctrl + F11 : 빌드 (컴파일 + 실행)
// F2 : 에러(빨간줄) 또는 경고(노란줄)가 있을 때 원인 및 해결책 띄우기
	...
	*/
	public static void main(String[] args) {
		...
		/*
		 	...
		 	- Command Line Interface (CLI <=> GUI) GUI: 마우스로 클릭하면 열림
									CLI : 경제적인 이유로 필요	
			# 세미콜론(;)
		...
		*/
		...
		System.out.println("432432"); // ""사이에 적는 숫자는 문자열이다
		System.out.println("3313번 버스"); // ex)
		
		//그냥 숫자끼리는 계산이 되지만 문자열 숫자는 이어붙이기를 한다
		System.out.println(123+10); // 133
		System.out.println(123 + "10"); // 12310
		
		// 2. 문자 예시(문자는 실제로는 숫자 값을 지니고 있다)
		System.out.println((int)'가');// '가'는 44032번째 문자입니다
		System.out.println((int)'韓');	 // '韓'은 38867번째 문자입니다
		System.out.println('감');
		System.out.println('배');
		System.out.println('귤');
		System.out.println((int)'A');// 'A'는 65번쨰 문자입니다
		System.out.println((int)'a');// 'a'는 97번째 문자입니다
		System.out.println('ㅁ');
		System.out.println('7');

		System.out.println(10 + 9); //19
		System.out.println(10 + '9'); //67? '9'=57 10+57=67
		//System.out.println('사과'); 문자가 두개라 안됨 ''사이엔 문자 하나만 
		...
		System.out.println("안경을 썻나요? " + true);
