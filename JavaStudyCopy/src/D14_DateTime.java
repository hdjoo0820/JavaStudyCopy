...
public class D14_DateTime {
	...
	*/
	public static void main(String[] args) {		
		...
		// plus, minus 메서드를 통해 
		// 해당 인스턴스를 기준으로 새로운 시간을 만들어낼 수 있다
		...
		System.out.println("10일 뒤의 날짜: " 
				+ now_dt.plusDays(10).getDayOfMonth());
		...
		// getMonth()할 때도 Month 클래스 인스턴스를 반환한다
...
//		
		...
		// (시간조질기들 클래스에 시간조절기가 들어있다)
		LocalDate childrensDay = LocalDate.of(2424, 5, 5);		
		...
		// With 메서드와 함께
		// TemporalAdjuster의 여러 시간조절기들을 꺼내 쓸 수 있다
		System.out.println("어린이날이 포함된 달의 마지막 날: "
				+ childrensDay.with(TemporalAdjusters.lastDayOfMonth()));
		
		System.out.println("어린이날 다음달의 마지막 날짜: " 
				+ childrensDay.plusMonths(1)
					.with(TemporalAdjusters.lastDayOfMonth()));
		
		System.out.println("저번주 수요일: " 
				+ LocalDate.now()
					.with(TemporalAdjusters.previous(DayOfWeek.WEDNESDAY)));
		
		System.out.println("이번 달의 2번째 수요일: " 
