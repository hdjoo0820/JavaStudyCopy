...
public class D01_ArrayList {
	...
	public static void main(String[] args) {
		...
		// add(index, data) : 원하는 위치에 데이터 추가(LinkedList에도 있음)
		list.add(4, 999);
		...
		// Object타입으로 꺼낸 값을 다시 활용하기위해 다운캐스팅이 필요하다
		...
		// 일치하는 값이 여러개면 맨 앞에 있는 값 하나만 지운다(성공 여부를 반환한다)
