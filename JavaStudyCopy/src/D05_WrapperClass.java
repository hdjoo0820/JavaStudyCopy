	...
	*/
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("double타입은 몇바이트?" + Double.BYTES);
		System.out.println("int의 최대값은? " + Integer.MAX_VALUE);
		System.out.println("int의 최대값은? " + Integer.MIN_VALUE);
		...
		System.out.println(("공백인가요? " + Character.isWhitespace(' '))); // 공백 찾기 Whitespace 
		...
		System.out.println("자바의 변수로 활용할 수 있는 문자인가요? " + 	
				Character.isJavaIdentifierPart('#'));
		System.out.println("자바의 변수로 활용할 수 있는 문자인가요? " + 	
				Character.isJavaIdentifierPart('ㅁ'));
	}	
