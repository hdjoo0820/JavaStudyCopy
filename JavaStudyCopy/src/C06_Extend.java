...
public class C06_Extend {
	 ...
	 *  
	 * - 자식 클래스는 부모로부터 물려받은 변수 및 기능을 마음대로 고쳐서 사용할 수 있다 마음대로 고쳐서 사용할 수 있다 (오버라이드,Override)
	 *  
	 ...
	 * - 자식 클래스와 부모 클래스에서 같은 이름을 가지고 있는 
	 *   자원을 구분하기 위해서 사용한다
	 * - this()는 현재 클래스를 의미하고 super()는 부모 클래스의 생성자를 의미한다 
	 * 
	 */
