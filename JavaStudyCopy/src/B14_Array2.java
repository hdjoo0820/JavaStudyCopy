...
public class B14_Array2 {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println(arr5[3][2]);// arr1 의 3
		System.out.println(arr5[5][2]);// arr3 의 3번째 값 저장이 안되어있어서 0
		
		// 배열의 변수명으로 값을 전달하는 것은
		// 해당 변수명이 가르키고 있는 실체(배열)의 위치를 전달하는 것이다
		// 아래 예제에서 javaClass의 실체는 하나이기 때문에
		// school[0][0]을 변경하면 		
		// school[0]과 javaClass가 함께 가르키고 있는 같은 실체를 변경하게 된다
		...
		// <연습> : messages에 포함된 모든 요소를 하나씩 출력해보세요
