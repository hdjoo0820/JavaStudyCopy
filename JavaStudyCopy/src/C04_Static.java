...
class TrumphCard {
	...
	int rank; // A ~ K
	int suit; // 스페이드 0, 하트 1,  다이아몬드 2, 클로버 3
	
	// 카드의 너비와 높이는 모든 인스턴스에서 다를 필요가 없는 값이다
	// 이런 성질의 변수를 인스턴스 값으로 두면 메모리 공간이 낭비된다
	...
	static void printCardInfo() {
		System.out.print("이 카드의 너비: " + card_width);
		System.out.print("이 카드의 높이: " + card_height);
		//System.out.print("이 카드의 랭크: " + rank);
	}
