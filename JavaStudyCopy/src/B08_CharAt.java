...
public class B08_CharAt {
	...
	*/
	public static void main(String[] args) {
		...
		//ch = str.charAt(4); // 문자열이 4글자 일때 마지막 인덱스는 3번이다
		...
		System.out.println("마지막 글자: " + str2.charAt(str2.length() - 1)); // e
		System.out.println(str2.charAt(str2.length() - 2)); // l
		System.out.println(str2.charAt(str2.length() - 3)); // p
		System.out.println(str2.charAt(str2.length() - 4)); // p
