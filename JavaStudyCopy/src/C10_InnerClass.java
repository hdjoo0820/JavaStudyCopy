...
public class C10_InnerClass {	
	...
	static class Subway{
		int line = L; // 그냥 int로 쓴 l은 오류남 static으로 쓰면 가능
		int color;
	}
	...
	public static void main(String[] args) {
		...
		// C10_InnerClass.Bus bus = new C10_InnerClass().new Bus();
		...
		// 예제
		Candy candy = new CandyFactory(1, 1).getCandy();		
