...
public class B12_Random {
	...
	*/
	public static void main(String[] args) {		
		...
		// 랜덤 시드를 생성하면서 원하는 시드 번호를 전달할 수 있다
		...
		for (int i = 0; i < 10; ++i) {
			...
			System.out.println(ran3.nextInt(10) - 5);// -5 ~ 4 (0 ~ 9를 각각 -5)
			System.out.println(ran3.nextInt(10) + 5);// 5 ~ 14 
		}
		
		// 연습> 40 ~ 60의 랜덤 숫자 10개
		for (int i = 0; i < 10; ++i) {
			System.out.println(ran3.nextInt(21) + 40);
		}
