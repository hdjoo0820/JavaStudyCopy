...
public class B07_For {
	/*
		...
		- 초기값 : for문을 처음 시작하면 단 한번 실행되는 곳
				 주로 반복자(interator)를 초기화 하는데에 사용한다
		- 반복조건 : 반복 조건이 true인 동안 {}안의 내용을 계속 실행한다
	...
	public static void main(String[] args) {
		...
		/*
		  	...
		  	- 원하는 횟수만큼 반복하고 싶을 때 가장 많이 사용하는 형태 
		  	  (int i = 0; i < 10; ++i) 여기서 10을 내가원하는 횟수로
		 */
		for (int i = 0; i < 10; ++i) {
...
//		// <연습>1. byte 타입의 모든 값을 최소값부터 최대값까지 출력
//		
...
//		
//		
//		// <연습>2. char 타입의 모든 문자를 최소값부터 최대값까지 출력
//		
//		for (char c = 0; c < 65356; ++c) {
...
//		}
		...
		for (int i = -128; i <= 127; ++i) {
			if (i == -128) {
				...
				System.out.print(i + ", ");
			} // (byte를 쓰면 128이아닌 -128로 가서 무한반복이 된다)
