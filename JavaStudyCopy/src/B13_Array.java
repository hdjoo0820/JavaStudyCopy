...
public class B13_Array {
	...
	*/
	public static void main(String[] args) {
		...
		// 배열로 선언한 변수를 사용하고 싶을 때는 배열이름 뒤에
		// 방 번호를 붙여야 한다
		// 배열의 방 번호는 0번부터 시작한다
		...
		numbers[4] = 'A'; //int = 4바이트 char = 2바이트 여서 가능 
		
		// 마지막 인덱스는 (배열의 크기 -1)번이다
		numbers[99] = 1000;
		//numbers[100] = -123; 0~99까지여서 오류
...
//		System.out.println(c);
		...
		// 배열은 선언과 동시에 정해진 값으로 초기화를 미리 해둠
		...
		double[] avgs = new double[] { // 문자열은 안들어감
				99.8, 75,5, 70.0, 60.8, 0.0, 2.3, 3.3, 4.4,
				'김', 234234234234234L, 123456, 3.1234F, 
		};
		...
		System.out.println(avgs);// 내용을 출력하고 싶으면 [] 안에 숫자 넣기
	}
